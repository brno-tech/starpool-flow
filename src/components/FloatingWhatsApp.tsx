...
const FloatingWhatsApp = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-scale-in">
      {/* Tooltip */}
      {showTooltip && (
        <div className="absolute bottom-20 right-0 glass-dark rounded-2xl p-4 shadow-2xl max-w-xs animate-slide-in-right">
          <button
          ...
          <p className="text-white/80 text-xs">
            Clique aqui e fale conosco no WhatsApp. Estamos prontos para tirar suas dúvidas!
          </p>
        </div>
      )}
      ...
      <button
        onClick={handleClick}
        className="group relative w-16 h-16 bg-[#25D366] hover:bg-[#20BA5A] rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110 pulse-glow"
